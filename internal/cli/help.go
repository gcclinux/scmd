...
func printInteractiveHelp() {
	...
	fmt.Println("──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────")
	fmt.Println("  /add <cmd> | <desc>   - Add a new command (use | separator)   │  /ai                   - Show AI/Ollama status")
	fmt.Println("  /search <pattern>     - Search for commands matching pattern  │  /config               - Show current config.json settings")
	fmt.Println("  /delete <id>          - Delete a command by ID                │  /embeddings           - Check embedding statistics")
	...
	fmt.Println("  /help or /?           - Show this help message                │  /exit, /quit, or /q   - Exit interactive mode")
	fmt.Println("──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────")
	...
	fmt.Println("  /fedora <query>       - Fedora expert persona                 │  /research <query>     - Analyse, recommend & Document persona")
	fmt.Println("  /archlinux <query>    - Arch Linux master persona             │  /code <query>         - Read, Think, execute Agentic RAG")
	fmt.Println("──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────")
