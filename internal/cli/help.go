...
func printInteractiveHelp() {
	...
	fmt.Println("──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────")
	fmt.Println("  /setup                - Edit & create current config.json     │  /ai                   - Show AI/Ollama status")
	fmt.Println("  /add <cmd> | <desc>   - Add a new command (use | separator)   │  /config               - Show current config.json settings")
